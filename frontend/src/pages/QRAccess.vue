...
const accessDetails = ref({
  ...
  description: 'Réunion avec l\'équipe de développement concernant les spécifications du nouveau projet',
  instructions: 'Veuillez escorter jusqu\'à la salle de réunion B-205. Pièce d\'identité requise.',
